# data: https://link.springer.com/protocol/10.1007/978-1-4939-6682-0_14
...
# https://www.youtube.com/watch?v=LoTnJ_IWCQs
...
# load data and read into R
# just by clicking on the .RData file
...
## When data are not normal, you can improve normality of the original phenotypic data using
...
# write a code to do the filtering
